...
@ApplicationScoped
public class CareerLevelEntitySubject extends SubjectAbs {
	
	public CareerLevelEntitySubject() {
	...
	public String getIconName() {
		return "fa fa-solid fa-chart-column";
	}
	...
	public Class<?> getKlass() {
		return CareerLevelEntity.class;
	}
